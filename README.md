...
Возможность изменять фоновый цвет для разных типов занятий или заданий.
...
Отображение или скрытие интересующих столбцов в расписании. Данный функционал доступен только в **табличном** формате расписания.
